...
<body>
    ...
    <form>
        <div class="container col row-2 mt-4">
            ...
            <div class="mb-3">
               <ul>Curso de enfermería SENA 2022.</ul>
               <ul>Curso excel SENA.</ul>
               <ul>Curso soldadura SENA.</ul>
               <ul>Sistemas SENA 2022.</ul>
               <ul>Curso cocina SENA 2022.</ul>
               <ul>Especializaciones SENA 2022.</ul>
               <ul>Salud ocupacional SENA 2022.</ul>
               <ul>Curso manipulación de alimentos SENA 2022.</ul>
            </div>
    </form>
