...
<body>
    ...
    <form>
        <div class="container col row-2 mt-4">
            ...
            <div class="mb-3">
               <ul> Tecnólogos:</ul>
               <ul> Análisis y desarrollo de sistemas de información.</ul>
               <ul> Distribución física internacional.</ul>
               <ul> Gestión de mercados.</ul>
               <ul> Gestión logística.</ul>
               <ul> Negociación internacional.</ul>
               <ul> Producción multimedia.</ul>
            </div>
    </form>
